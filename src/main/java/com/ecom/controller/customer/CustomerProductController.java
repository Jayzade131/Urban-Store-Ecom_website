...
public class CustomerProductController {
	...
	public ResponseEntity<ProductDetailDto> getProductDeatils(@PathVariable Long productId)
	{
		ProductDetailDto productDetailById = customerServiceProduct.getProductDetailById(productId);
		
		if(productDetailById ==null) return ResponseEntity.notFound().build();
		
		return ResponseEntity.ok(productDetailById);
	}
}
